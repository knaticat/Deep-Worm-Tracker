...
class Worm(VideoDataset):
    ...
    def __init__(self, root='', **kwargs):
        ...
        self.track_train_info_path = osp.join( self.dataset_dir, 'info/track_train_info.mat')
        self.track_test_info_path = osp.join(self.dataset_dir, 'info/track_test_info.mat')
        ...
        track_train = loadmat(self.track_train_info_path)['track_train_info'] #numpy array (94,4)
        track_test = loadmat(self.track_test_info_path)['track_test_info'] #numpy array (13,4)
        query_IDX = loadmat(self.query_IDX_path)['query_IDX'].squeeze() # numpy array (4,)
        ...
        super(Worm, self).__init__(train,querry,gallery,**kwargs)
    ...
    def process_data(
        ...
        for tracklet_idx in range(num_tracklets):
            ...
            #make sure all images are captured undeer the same camera
